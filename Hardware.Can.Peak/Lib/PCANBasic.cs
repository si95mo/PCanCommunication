...
namespace Hardware.Can.Peak.Lib
{
    ...
    public static class PCANBasic
    {
        ...
        #endregion PCAN-BUS Handles Definition
        ...
        #endregion FD Bit rate parameters
        ...
        #endregion Parameter values definition
        ...
        #endregion PCANBasic API Implementation
    }

    #endregion PCANBasic class
}